					...
					<div id="featured_info_display">
						<br />
 						<h3 style="text-align: center;">
							<font style="font-family: courier" size="5" color="#151B8D">Namespace Administration</font>
						</h3>
						<br>
						<div id="vertmenu"> 
							<ul>
								<li><a href="/vshards-web-ui/store/add" tabindex="1">Add Namespace</a></li>
								<li><a href="/vshards-web-ui/store/update" tabindex="2">Update Namespace</a></li>
								<li><a href="/vshards-web-ui/store/clear" tabindex="3">Clear Namespace</a></li>
								<li><a href="/vshards-web-ui/store/delete" tabindex="4">Delete Namespace</a></li>
							</ul>
						</div>
